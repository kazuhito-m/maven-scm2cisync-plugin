...
import tk.bnbm.scm2cisync.core.controller.ci.JenkinsControler;
import tk.bnbm.scm2cisync.core.controller.scm.SubversionControler;
import tk.bnbm.scm2cisync.mojo.SynchronizeTarget;

import java.io.File;
import java.util.*;

import static org.junit.Assert.fail;
import static tk.bnbm.scm2cisync.core.TestConstants.*;
...
public class ScmToCiSynchronizerTest {
    ...
    public void setUp() throws Exception {
        ...
        st.setScmUrl(TEST_SVN_URL);
        st.setCiType("Jenkins");
        st.setCiUrl(TEST_JENKINS_URL);
        st.setCiControlJobName(TEST_JEKNINS_JOB);
    ...
    public void testSynchronize001() throws Exception {
        ...
        Set<String> exclude = new HashSet<String>(Arrays.asList(TEST_JEKNINS_JOBS));
        for (String job : jobs) {
        ...
        joblist.add("test");
        jc.updateManagingJobNamesForControlJob(TEST_JEKNINS_JOB, joblist);
    ...
    public void testSynchronize002() throws Exception {
        ...
        // Arrange-準備
        st.setScmUrl(TEST_SVN_AUTH_URL);
